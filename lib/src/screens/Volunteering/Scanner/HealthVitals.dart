...
class HealthVitalsPage extends StatefulWidget {
  ...
  const HealthVitalsPage(this.elderlyUid, {super.key});
...
class _HealthVitalsPageState extends State<HealthVitalsPage> {
  ...
  //TODO reference from https://gitlab.com/senzehubiot/senzepact_health_scanner/-/blob/master/src/screens/HealthCheckScreen/HealthCheckVitals.js?ref_type=heads
  void handleWifiDeviceInput() {
    // Implement handling wifi device input
  }
  ...
  void readSensorValue() {
    // Implement reading sensor value logic
  }

  void removePairedDevice() {
    // Implement removing paired device logic
  }
                  ...
                  child: Column(
                    children: [
                      ElevatedButton(
                        ...
                        child: Text('Input vitals manually'),
                      ),
                      Text(
                          '------------------------- or -------------------------'),
                      ElevatedButton(
                        onPressed: handleAutoInput,
                        child: Text('Retrieve vitals from wearable'),
                      ),
                      Text(
                          '------------------------- or -------------------------'),
                      ElevatedButton(
                        onPressed: handleWifiDeviceInput,
                        child: Text('Retrieve vitals from device'),
                      ),
                    ],
                  ),
                ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: readSensorValue,
                          child: Text('Read Vitals'),
                        ),
                        ElevatedButton(
                          onPressed: removePairedDevice,
