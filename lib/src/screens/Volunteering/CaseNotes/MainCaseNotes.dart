...
import 'package:senzepact/src/screens/Volunteering/CaseNotes/CaseNotesList.dart';
...
class MainCaseNotesPage extends StatefulWidget {
  final VolunteeringService service;

  const MainCaseNotesPage({Key? key, required this.service}) : super(key: key);

  @override
  State<MainCaseNotesPage> createState() => MainCaseNotesPageState();
}

class MainCaseNotesPageState extends State<MainCaseNotesPage> {
  var elderlyList = [];
  bool isLoading = true;
