...
class HealthHistoryHeartRatePage extends StatefulWidget {
  const HealthHistoryHeartRatePage({Key? key}) : super(key: key);

  @override
  State<HealthHistoryHeartRatePage> createState() =>
      _HealthHistoryHeartRatePageState();
}

class _HealthHistoryHeartRatePageState
    extends State<HealthHistoryHeartRatePage> {
  var userUid = "";
  var userName = "";
  var healthData = [];
  ...
  retrieveData() async {
    ...
    for (var queryDocumentSnapshot in querySnapshot.docs) {
      ...
      healthValues.add(_HealthData(
          formattedDateTime, double.parse(data['HeartRate'].toString())));
    }
    setState(() {
                ...
                if (healthValues.isNotEmpty)
                  SingleChildScrollView(
                    ...
                    child: SfCartesianChart(
                        ...
                        // Chart title
                        title: ChartTitle(text: 'HEART RATE'.tr()),
                        // Enable legend
