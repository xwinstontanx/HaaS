...
class HealthHistoryTemperaturePage extends StatefulWidget {
  const HealthHistoryTemperaturePage({Key? key}) : super(key: key);

  @override
  State<HealthHistoryTemperaturePage> createState() =>
      _HealthHistoryTemperaturePageState();
}

class _HealthHistoryTemperaturePageState
    extends State<HealthHistoryTemperaturePage> {
  var userUid = "";
  var userName = "";
  var healthData = [];
  ...
  retrieveData() async {
    ...
    for (var queryDocumentSnapshot in querySnapshot.docs) {
      ...
      healthValues.add(_HealthData(
          formattedDateTime, double.parse(data['Temperature'].toString())));
