...
class HealthHistoryBMIPage extends StatefulWidget {
  const HealthHistoryBMIPage({Key? key}) : super(key: key);

  @override
  State<HealthHistoryBMIPage> createState() => _HealthHistoryBMIPageState();
}

class _HealthHistoryBMIPageState extends State<HealthHistoryBMIPage> {
  var userUid = "";
  var userName = "";
  var healthData = [];
  ...
  retrieveData() async {
    ...
    for (var queryDocumentSnapshot in querySnapshot.docs) {
      ...
      healthData.add(
          {'createdAt': formattedDateTime, 'value': data['BMI'].toString()});

      healthValues.add(
          _HealthData(formattedDateTime, double.parse(data['BMI'].toString())));
    }
    setState(() {
